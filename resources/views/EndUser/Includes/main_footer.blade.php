            ...
            <div class="col-lg-12">
                <div class="footer-card-content">
                    <div class="footer-payment">
                        <a href="#"><img src="{{asset('assetsEndUser/images/pay-card/01.jpg')}}" alt="01"></a>
                        <a href="#"><img src="{{asset('assetsEndUser/images/pay-card/02.jpg')}}" alt="02"></a>
                        <a href="#"><img src="{{asset('assetsEndUser/images/pay-card/03.jpg')}}" alt="03"></a>
                        <a href="#"><img src="{{asset('assetsEndUser/images/pay-card/04.jpg')}}" alt="04"></a>
                    </div>
                    ...
                    <div class="footer-app">
                        <a href="#"><img src="{{asset('assetsEndUser/images/play-store.png')}}" alt="play-store"></a>
                        <a href="#"><img src="{{asset('assetsEndUser/images/app-store.png')}}" alt="app-store"></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="footer-end">
        <div class="container">
            <div class="footer-end-content">
                <p>All Copyrights Reserved &copy; 2021 - Developed by <a href="#">Unlimited Software</a></p>
